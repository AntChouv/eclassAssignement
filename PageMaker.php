...
class PageMaker {
    ...
    public function startPageStud() {
        ...
        public function startPageDefault() {
        ?>
        <div style="margin: 30px">
            <div class="row">
                <div class="col-sm-4">
                    <img src="s.JPG" style="width: 50%">
                    <br>
                    <h2>Important Info For Sign Up</h2>
                    <p>If you want to create an account go to Sign Up & Log In and select Sing Up. There you will have to fill up a form
                    with your credentials. Be careful to enter a valid Username and Email and select the role you are supposed to have. Your application
                    will be viewed be the admin and if your credentials are correct you will be able to Log In. If your credentials are not valid your application
                    will be denied.</p>
                    
                </div>
                <div class="col-sm-8">
                    <h2>Visitors Actions</h2>
                    <p>If you don't have a profile and you do not wish to create one you can just browse the page. You can see the available courses and in which year and semester they are being taught
                    ,or you can just see the students and the professors of the school</p>
                    <h3>Some Important Links</h3>
                    <p>Some important actions of visitor. The Export Passed Courses is the solution for the 10% bonus question 
                    requirement no2 page 9 in the project description.</p>
                    <ul class="nav nav-pills flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="signUpLogIn.php?action=printCourses">Search Courses</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="signUpLogIn.php?action=printStudents">Search Student</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="signUpLogIn.php?action=printProfessors">Search Professor</a>
                        </li>
